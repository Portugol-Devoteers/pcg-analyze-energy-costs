...
export const Header = () => {
    return (
        <header className="bg-white w-full fixed flex flex-col justify-center items-center gap-3 sm:gap-0 sm:flex-row sm:justify-between sm:items-center border py-3 ">
